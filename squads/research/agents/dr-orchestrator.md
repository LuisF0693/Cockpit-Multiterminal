...
use_case_classification:
  ...
  technical_deep_dive:
    ...
    primary_agents: ["forsgren", "tech-research-agent"]
    secondary_agents: ["klein", "bench-analyst"]
    description: |
  ...
  strategic_decision_support:
    ...
    secondary_agents: ["forsgren", "tech-research-agent"]
    description: |
  ...
  academic_scientific:
    ...
    primary_agents: ["tech-research-agent"]
  ...
  market_intelligence:
    ...
    primary_agents: ["gilad", "bench-analyst"]
...
tools:
  ...
  available_now:
    - tool: "Exa AI"
      agents: ["forsgren", "bench-analyst", "gilad", "orchestrator"]
