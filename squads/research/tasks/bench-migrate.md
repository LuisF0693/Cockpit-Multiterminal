...
task: benchMigrate()
responsavel: reference-competitor-clone
...
- revisão humana obrigatória antes de publish final
...
agent: reference-competitor-clone
elicit: false
autonomous: true
...
**OUTPUT:** Write `docs/bench/{subject_a}-vs-{subject_b}/deep/{subject_a}-vs-{subject_b}-migration-playbook.md`
...
| File | Format |
|------|--------|
| `{subject_a}-vs-{subject_b}-migration-playbook.md` | MD |
...
accountability:
  ...
  responsible: "reference-competitor-clone"
