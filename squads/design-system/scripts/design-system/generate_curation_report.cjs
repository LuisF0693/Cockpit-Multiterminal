 ...
 *   - docs/research/design-system-extraction/{brand}/curation-report.md (human-readable report)
 */
...
const REPORT_MD = path.join(REPORTS_DIR, 'curation-report.md');
...
function main() {
  ...
  let md = `# Curation Report — ${report.brand} Design System\n\n`;
