...
- **Epic 12 — Identidade Visual & Interação no Canvas:** barra lateral unificada (projetos+arquivos+preview Markdown), vínculo por arraste no canvas, cor por projeto/agente nos terminais, adapters Gemini CLI e Antigravity, minimapa (FR34-40, formalizado 2026-07-14).
