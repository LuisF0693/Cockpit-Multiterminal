...
- **Epic 13 — Refinamento Visual & Superfícies de Referência:** tema visual coeso por design tokens (feedback direto do fundador: "tô achando um pouco feio"), toolbar do canvas, status bar global com branch git, catálogo de agentes, tela de Configurações (FR41-46, formalizado 2026-07-15). Backlog do épico aguardando elicitação: painel MCP Agents, mapa do código/grafo, adapter Hermes.
