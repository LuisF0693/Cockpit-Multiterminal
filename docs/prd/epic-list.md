...
- **Epic 7 — SDC Embutido & Three-Brain (backlog):** ciclo canônico com revisão cruzada multi-modelo.
- **Epic 8 — Learning Logs Globais (backlog):** banco de learnings fora dos projetos.
