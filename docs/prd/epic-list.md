...
- **Epic 11 — Learning Logs Globais:** registro manual de aprendizados (gotchas/decisões/padrões), qualificação humana (draft→reviewed→reusable/discarded), consulta global independente do projeto ativo (FR30-33, formalizado 2026-07-14).
