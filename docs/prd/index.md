# Meu Cockpit — Product Requirements Document (PRD) — Index

> Sharded de `prd.md` em 2026-07-10 por @po.
...
6. [Epic 1 — Fundação & Multi-Terminal](./epic-1-fundacao-multi-terminal.md)
7. [Epic 2 — Adapter Design & Agentes](./epic-2-adapter-design-agentes.md)
...
12. [Epic 7 — SDC Embutido & Three-Brain](./epic-7-sdc-three-brain.md)
13. [Checklist Results Report](./checklist-results-report.md)
14. [Next Steps](./next-steps.md)
